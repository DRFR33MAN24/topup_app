...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: AppDrawer(),
      body: !Provider.of<ProfileProvider>(context, listen: false).isLoading
          ? SafeArea(
                              ...
                              builder: (context, categoryProvider, child) {
                                ...
                                return Column(children: [
                                        ...
                                        onPressed: (int index) {
                                          setState(() {
                                            for (int buttonIndex = 0;
                                                ...
                                                buttonIndex++) {
                                              cat.Tag buttonIndexTag = tagsMap
                                                  .keys
                                                  .toList()[buttonIndex];
                                              if (buttonIndex == index) {
                                                if (buttonIndexTag.tag ==
                                                    "Balance") {
                                  ...
                                  categoryList.isNotEmpty
                                      ? SizedBox(
                                          height: Dimensions.cardHeight - 40,
                                          child: RefreshIndicator(
                                            onRefresh: () async {
                                              _loadData(true);
                                            },
            ...
            Column(
              ...
              children: [
                ...
                Provider.of<SplashProvider>(context, listen: false)
                            .currentCurrency ==
                        "USD"
                    ? Text("${formatter.format(profile.balance ?? 0.0)} \$",
                    ...
                    : Text(
                        ...
                        "${formatterlbp.format(profile.lbalance)} \LBP",
                        style: robotoBold.copyWith(
                          fontSize: 18,
                          fontStyle: FontStyle.italic,
                        ))
