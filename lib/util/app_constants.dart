...
class AppConstants {
  ...
  static const String profile_url = '/storage/profile/';
  ...
  static const String transaction =
      '/api/transactions/transactions?limit=100&&offset=';
  ...
  static const String latestCategories = '/api/categories/categories?limit=20';
  static const String latestOrders = '/api/orders/orders?limit=100';
